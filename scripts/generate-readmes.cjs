...
const TS_PACKAGES = [
    { name: 'shared', dir: 'packages/shared', npm: '@macroforge/shared' },
    {
        ...
        npm: '@macroforge/typescript-plugin'
    },
    { name: 'vite-plugin', dir: 'packages/vite-plugin', npm: '@macroforge/vite-plugin' },
    {
        ...
        npm: '@macroforge/svelte-preprocessor'
    },
 ...
 */
function generateRustReadme(_config, docs) {
    const lines = [];
    ...
    // Badges
    lines.push(
        `[![Crates.io](https://img.shields.io/crates/v/${docs.name}.svg)](https://crates.io/crates/${docs.name})`
    );
    lines.push(
        `[![Documentation](https://docs.rs/${docs.name}/badge.svg)](https://docs.rs/${docs.name})`
    );
    lines.push('');
    ...
    lines.push('');
    lines.push(
        `See the [full API documentation](https://macroforge.dev/docs/api/reference/rust/${docs.name}) on the Macroforge website.`
    );
    lines.push('');
...
function generateTsReadme(config, docs) {
    ...
    // Badges
    lines.push(
        `[![npm version](https://badge.fury.io/js/${encodeURIComponent(config.npm)}.svg)](https://www.npmjs.com/package/${config.npm})`
    );
    lines.push('');
    ...
    // Key exports
    const keyExports = docs.items.filter((item) => item.description && !item.name.startsWith('_'));
    ...
    lines.push('');
    lines.push(
        `See the [full documentation](https://macroforge.dev/docs/api/reference/typescript/${config.name}) on the Macroforge website.`
    );
    lines.push('');
