    ...
    if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
        ...
        if (process.arch === 'arm64') {
            ...
            try {
                ...
                const bindingPackageVersion =
                    require('@playground/macro-android-arm64/package.json').version;
                if (
            ...
            try {
                ...
                const bindingPackageVersion =
                    require('@playground/macro-android-arm-eabi/package.json').version;
                if (
                    bindingPackageVersion !== '0.0.1' &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
        ...
        if (process.arch === 'x64') {
            if (
                ...
                try {
                    ...
                    const bindingPackageVersion =
                        require('@playground/macro-win32-x64-gnu/package.json').version;
                    if (
                        bindingPackageVersion !== '0.0.1' &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
                ...
                try {
                    ...
                    const bindingPackageVersion =
                        require('@playground/macro-win32-x64-msvc/package.json').version;
                    if (
                        bindingPackageVersion !== '0.0.1' &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
            ...
            try {
                ...
                const bindingPackageVersion =
                    require('@playground/macro-win32-ia32-msvc/package.json').version;
                if (
                    bindingPackageVersion !== '0.0.1' &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
            ...
            try {
                ...
                const bindingPackageVersion =
                    require('@playground/macro-win32-arm64-msvc/package.json').version;
                if (
                    bindingPackageVersion !== '0.0.1' &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
        ...
        if (process.arch === 'x64') {
            ...
            try {
                ...
                const bindingPackageVersion =
                    require('@playground/macro-darwin-x64/package.json').version;
                if (
                    bindingPackageVersion !== '0.0.1' &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
            ...
            try {
                ...
                const bindingPackageVersion =
                    require('@playground/macro-darwin-arm64/package.json').version;
                if (
                    bindingPackageVersion !== '0.0.1' &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
        ...
        if (process.arch === 'x64') {
            ...
            try {
                ...
                const bindingPackageVersion =
                    require('@playground/macro-freebsd-x64/package.json').version;
                if (
                    bindingPackageVersion !== '0.0.1' &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
            ...
            try {
                ...
                const bindingPackageVersion =
                    require('@playground/macro-freebsd-arm64/package.json').version;
                if (
                    bindingPackageVersion !== '0.0.1' &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
        ...
        if (process.arch === 'x64') {
            if (isMusl()) {
                ...
                try {
                    ...
                    const bindingPackageVersion =
                        require('@playground/macro-linux-x64-musl/package.json').version;
                    if (
                        bindingPackageVersion !== '0.0.1' &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
                ...
                try {
                    ...
                    const bindingPackageVersion =
                        require('@playground/macro-linux-x64-gnu/package.json').version;
                    if (
                        bindingPackageVersion !== '0.0.1' &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
            ...
            if (isMusl()) {
                ...
                try {
                    ...
                    const bindingPackageVersion =
                        require('@playground/macro-linux-arm64-musl/package.json').version;
                    if (
                        bindingPackageVersion !== '0.0.1' &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
                ...
                try {
                    ...
                    const bindingPackageVersion =
                        require('@playground/macro-linux-arm64-gnu/package.json').version;
                    if (
                        bindingPackageVersion !== '0.0.1' &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
            ...
            if (isMusl()) {
                ...
                try {
                    ...
                    const bindingPackageVersion =
                        require('@playground/macro-linux-loong64-gnu/package.json').version;
                    if (
                        bindingPackageVersion !== '0.0.1' &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
            ...
            if (isMusl()) {
                ...
                try {
                    ...
                    const bindingPackageVersion =
                        require('@playground/macro-linux-riscv64-gnu/package.json').version;
                    if (
                        bindingPackageVersion !== '0.0.1' &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                        process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
            ...
            try {
                ...
                const bindingPackageVersion =
                    require('@playground/macro-linux-ppc64-gnu/package.json').version;
                if (
                    bindingPackageVersion !== '0.0.1' &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
            ...
            try {
                ...
                const bindingPackageVersion =
                    require('@playground/macro-linux-s390x-gnu/package.json').version;
                if (
                    bindingPackageVersion !== '0.0.1' &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
        ...
        if (process.arch === 'arm64') {
            ...
            try {
                ...
                const bindingPackageVersion =
                    require('@playground/macro-openharmony-arm64/package.json').version;
                if (
                    bindingPackageVersion !== '0.0.1' &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
            ...
            try {
                ...
                const bindingPackageVersion =
                    require('@playground/macro-openharmony-x64/package.json').version;
                if (
                    bindingPackageVersion !== '0.0.1' &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
            ...
            try {
                ...
                const bindingPackageVersion =
                    require('@playground/macro-openharmony-arm/package.json').version;
                if (
                    bindingPackageVersion !== '0.0.1' &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
                    process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
...
module.exports.parseImportSources = nativeBinding.parseImportSources;
module.exports.scanProjectSync = nativeBinding.scanProjectSync;
module.exports.scanProjectSync = nativeBinding.scanProjectSync;
