...
export interface TextAreaFieldController extends FieldController<string | null> {}
...
export interface TagsFieldController extends FieldController<ReadonlyArray<string>> {}
...
export interface ComboboxFieldController<T = string> extends FieldController<T | null> {
...
export interface ComboboxMultipleFieldController<T = string>
...
export interface DateTimeFieldController extends FieldController<bigint | null> {}

/** Hidden field controller */
export interface HiddenFieldController<T = unknown> extends FieldController<T> {}
...
export interface AddressLookupFieldController<TSite = unknown>
...
export interface SiteFieldsetController<TSite = unknown> extends FieldController<TSite | null> {
