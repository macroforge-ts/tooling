...
export function svelteAllMacrosTestClone(value: SvelteAllMacrosTest): SvelteAllMacrosTest {
    ...
    return result as SvelteAllMacrosTest;
}

export function svelteAllMacrosTestEquals(a: SvelteAllMacrosTest, b: SvelteAllMacrosTest): boolean {
    if (a === b) return true;
    return a.id === b.id && a.title === b.title && a.content === b.content && a.apiKey === b.apiKey && a.count === b.count && a.enabled === b.enabled;
}

export function svelteAllMacrosTestSerialize(value: SvelteAllMacrosTest): string {
    const ctx = __mf_SerializeContext.create();
    return JSON.stringify(svelteAllMacrosTestSerializeWithContext(value, ctx));
}
export function svelteAllMacrosTestSerializeWithContext(value: SvelteAllMacrosTest, ctx: __mf_SerializeContext): Record<string, unknown> {
...
export function svelteAllMacrosTestDeserialize(input: unknown, opts: __mf_DeserializeOptions): { success: true; value: SvelteAllMacrosTest } | { success: false; errors: Array<{ field: string; message: string }> } {
    try {
...
export function svelteAllMacrosTestDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): SvelteAllMacrosTest | __mf_PendingRef {
...
export function svelteAllMacrosTestValidateField<K extends keyof SvelteAllMacrosTest>(_field: K, _value: SvelteAllMacrosTest[K]): Array<{
    field: string;
    message: string;
}> {
    return [];
}
export function svelteAllMacrosTestValidateFields(_partial: Partial<SvelteAllMacrosTest>): Array<{
    field: string;
    message: string;
}> {
    return [];
...
export function svelteAllMacrosTestHasShape(obj: unknown): boolean {
    ...
    return '"id" in o && "title" in o && "content" in o && "apiKey" in o && "count" in o && "enabled" in o';
}
