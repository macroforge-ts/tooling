...
export function userWithDeserializeDeserialize(input: unknown, opts: __mf_DeserializeOptions): { success: true; value: UserWithDeserialize } | { success: false; errors: Array<{ field: string; message: string }> } {
    try {
...
export function userWithDeserializeDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): UserWithDeserialize | __mf_PendingRef {
...
export function userWithDeserializeValidateField<K extends keyof UserWithDeserialize>(_field: K, _value: UserWithDeserialize[K]): Array<{
    field: string;
    message: string;
}> {
    return [];
}
export function userWithDeserializeValidateFields(_partial: Partial<UserWithDeserialize>): Array<{
    field: string;
    message: string;
}> {
    return [];
...
export function fullFeaturedTypeDeserialize(input: unknown, opts: __mf_DeserializeOptions): { success: true; value: FullFeaturedType } | { success: false; errors: Array<{ field: string; message: string }> } {
    try {
        const data = typeof input === "string" ? JSON.parse(input) : input;
        const ctx = __mf_DeserializeContext.create();
...
export function fullFeaturedTypeDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): FullFeaturedType | __mf_PendingRef {
    if (value?.__ref !== undefined) {
        return ctx.getOrDefer(value.__ref);
    }
    if (typeof value !== "object" || value === null || Array.isArray(value)) {
...
export function fullFeaturedTypeValidateField<K extends keyof FullFeaturedType>(_field: K, _value: FullFeaturedType[K]): Array<{
    field: string;
    message: string;
}> {
    return [];
}
export function fullFeaturedTypeValidateFields(_partial: Partial<FullFeaturedType>): Array<{
    field: string;
    message: string;
}> {
    return [];
...
export function fullFeaturedTypePartialCompare(a: FullFeaturedType, b: FullFeaturedType): number | null {
    if (a === b) return 0;
...
export function typeADeserialize(input: unknown, opts: __mf_DeserializeOptions): { success: true; value: TypeA } | { success: false; errors: Array<{ field: string; message: string }> } {
    try {
        const data = typeof input === "string" ? JSON.parse(input) : input;
        const ctx = __mf_DeserializeContext.create();
...
export function typeADeserializeWithContext(value: any, ctx: __mf_DeserializeContext): TypeA | __mf_PendingRef {
    if (value?.__ref !== undefined) {
        return ctx.getOrDefer(value.__ref);
    }
    if (typeof value !== "object" || value === null || Array.isArray(value)) {
        throw new __mf_DeserializeError([
            {
                field: "_root",
                message: `${"TypeA"}.deserializeWithContext: expected an object`
            }
        ]);
    }
    const obj = value as Record<string, unknown>;
...
export function typeAValidateField<K extends keyof TypeA>(_field: K, _value: TypeA[K]): Array<{
    field: string;
    message: string;
}> {
    return [];
}
export function typeAValidateFields(_partial: Partial<TypeA>): Array<{
    field: string;
    message: string;
}> {
    return [];
...
export function typeBDeserialize(input: unknown, opts: __mf_DeserializeOptions): { success: true; value: TypeB } | { success: false; errors: Array<{ field: string; message: string }> } {
    try {
        const data = typeof input === "string" ? JSON.parse(input) : input;
        const ctx = __mf_DeserializeContext.create();
...
export function typeBDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): TypeB | __mf_PendingRef {
    if (value?.__ref !== undefined) {
        return ctx.getOrDefer(value.__ref);
    }
    if (typeof value !== "object" || value === null || Array.isArray(value)) {
        throw new __mf_DeserializeError([
            {
                field: "_root",
                message: `${"TypeB"}.deserializeWithContext: expected an object`
            }
        ]);
    }
    const obj = value as Record<string, unknown>;
...
export function typeBValidateField<K extends keyof TypeB>(_field: K, _value: TypeB[K]): Array<{
    field: string;
    message: string;
}> {
    return [];
}
export function typeBValidateFields(_partial: Partial<TypeB>): Array<{
    field: string;
    message: string;
}> {
    return [];
