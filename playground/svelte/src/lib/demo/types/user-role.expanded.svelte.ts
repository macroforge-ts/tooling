...
export type UserRoleAdministratorFieldControllers = {};
export type UserRoleSalesRepresentativeFieldControllers = {};
export type UserRoleTechnicianFieldControllers = {};
export type UserRoleHumanResourcesFieldControllers = {};
export type UserRoleInformationTechnologyFieldControllers =
