...
describe('BigInt Validators', () => {
    ...
    describe('GreaterThanBigInt', () => {
        test('accepts value greater than threshold', () => {
            const result = mod.GreaterThanBigIntValidator.deserialize(
        ...
        test('accepts large value', () => {
            const result = mod.GreaterThanBigIntValidator.deserialize(
                JSON.stringify({ value: '999999999999' })
            );
            assertValidationSuccess(result, 'value');
        });
    ...
    describe('LessThanBigInt', () => {
        test('accepts value less than threshold', () => {
            const result = mod.LessThanBigIntValidator.deserialize(
                JSON.stringify({ value: '999' })
            );
            assertValidationSuccess(result, 'value');
        });
    ...
    describe('LessThanOrEqualToBigInt', () => {
        test('accepts value equal to threshold', () => {
            const result = mod.LessThanOrEqualToBigIntValidator.deserialize(
                JSON.stringify({ value: '1000' })
            );
            assertValidationSuccess(result, 'value');
        });
    ...
    describe('PositiveBigInt', () => {
        ...
        test('accepts large positive value', () => {
            const result = mod.PositiveBigIntValidator.deserialize(
                JSON.stringify({ value: '999999999999999999' })
            );
            assertValidationSuccess(result, 'value');
        });
    ...
    describe('NonNegativeBigInt', () => {
        test('accepts zero', () => {
            const result = mod.NonNegativeBigIntValidator.deserialize(
                JSON.stringify({ value: '0' })
            );
            assertValidationSuccess(result, 'value');
        });
    ...
    describe('NonPositiveBigInt', () => {
        test('accepts zero', () => {
            const result = mod.NonPositiveBigIntValidator.deserialize(
                JSON.stringify({ value: '0' })
            );
            assertValidationSuccess(result, 'value');
        });
