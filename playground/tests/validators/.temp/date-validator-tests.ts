...
export class ValidDateValidator {
    ...
    static deserializeWithContext(
        ...
        ctx.trackForFreeze(instance);
        {
            ...
            {
                const __dateVal =
                    typeof __raw_date === 'string' ? new Date(__raw_date) : ($MfPh116 as Date);
                if (Number.isNaN(__dateVal.getTime())) {
                    errors.push({
                        field: 'date',
...
export function validDateValidatorDeserialize(
    input: unknown,
    opts: __mf_DeserializeOptions
):
    | {
...
export function greaterThanDateValidatorDeserialize(
    input: unknown,
    opts: __mf_DeserializeOptions
):
    | {
            ...
            const __raw_date = obj.date as Date;
            {
                ...
                if (__dateVal.getTime() < new Date('2020-01-01').getTime()) {
                    errors.push({
                        field: 'date',
                        message:
                            'GreaterThanOrEqualToDateValidator.date must be on or after 2020-01-01'
                    });
                }
                instance.date = __dateVal;
            }
...
export function greaterThanOrEqualToDateValidatorDeserialize(
    input: unknown,
    opts: __mf_DeserializeOptions
):
    | {
...
export function lessThanDateValidatorDeserialize(
    input: unknown,
    opts: __mf_DeserializeOptions
):
    | {
            ...
            const __raw_date = obj.date as Date;
            {
                ...
                if (__dateVal.getTime() > new Date('2030-01-01').getTime()) {
                    errors.push({
                        field: 'date',
                        message:
                            'LessThanOrEqualToDateValidator.date must be on or before 2030-01-01'
                    });
                }
                instance.date = __dateVal;
            }
...
export function lessThanOrEqualToDateValidatorDeserialize(
    input: unknown,
    opts: __mf_DeserializeOptions
):
    | {
            ...
            const __raw_date = obj.date as Date;
            {
                ...
                if (
                    ...
                    errors.push({
                        field: 'date',
                        message:
                            'BetweenDateValidator.date must be between 2020-01-01 and 2030-01-01'
                    });
                }
                instance.date = __dateVal;
            }
...
export function betweenDateValidatorDeserialize(
    input: unknown,
    opts: __mf_DeserializeOptions
):
    | {
