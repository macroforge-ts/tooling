...
constructor(props: { date: Date }) {
        ...
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: ValidDateValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): ValidDateValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "ValidDateValidator.deserializeWithContext: expected an object" }]);
            }

            const obj = value as Record<string, unknown>;
            const errors: Array<{ field: string; message: string }> = [];if (!("date" in obj)) {
            ...
            ctx.trackForFreeze(instance);{
                            const __raw_date = obj["date"] as string | Date;{
                                        const __dateVal = typeof __raw_date === "string" ? new Date(__raw_date) : __raw_date as Date;
                                                                            if (isNaN(__dateVal.getTime())) { errors.push({ field: "date", message: "ValidDateValidator.date must be a valid date" }); }
        ...
        static validateField<K extends keyof ValidDateValidator>(
            ...
            if (_field === "date") {
                const __val = _value as Date;
                                                if (isNaN(__val.getTime())) { errors.push({ field: "date", message: "ValidDateValidator.date must be a valid date" }); }
        ...
        static validateFields(
            _partial: Partial<ValidDateValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function validDateValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: ValidDateValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return ValidDateValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function validDateValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): ValidDateValidator | __mf_PendingRef {
...
constructor(props: { date: Date }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: GreaterThanDateValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): GreaterThanDateValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "GreaterThanDateValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                            const __raw_date = obj["date"] as string | Date;{
                                        const __dateVal = typeof __raw_date === "string" ? new Date(__raw_date) : __raw_date as Date;
                                                                            if (__dateVal.getTime() <= new Date("2020-01-01").getTime()) { errors.push({ field: "date", message: "GreaterThanDateValidator.date must be after 2020-01-01" }); }
        ...
        static validateField<K extends keyof GreaterThanDateValidator>(
            ...
            if (_field === "date") {
                const __val = _value as Date;
                                                if (__val.getTime() <= new Date("2020-01-01").getTime()) { errors.push({ field: "date", message: "GreaterThanDateValidator.date must be after 2020-01-01" }); }
        ...
        static validateFields(
            _partial: Partial<GreaterThanDateValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
            if ("date" in _partial && _partial.date !== undefined) {
                const __val = _partial.date as Date;
                                                if (__val.getTime() <= new Date("2020-01-01").getTime()) { errors.push({ field: "date", message: "GreaterThanDateValidator.date must be after 2020-01-01" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function greaterThanDateValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: GreaterThanDateValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return GreaterThanDateValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function greaterThanDateValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): GreaterThanDateValidator | __mf_PendingRef {
...
constructor(props: { date: Date }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: GreaterThanOrEqualToDateValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): GreaterThanOrEqualToDateValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "GreaterThanOrEqualToDateValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                            const __raw_date = obj["date"] as string | Date;{
                                        const __dateVal = typeof __raw_date === "string" ? new Date(__raw_date) : __raw_date as Date;
                                                                            if (__dateVal.getTime() < new Date("2020-01-01").getTime()) { errors.push({ field: "date", message: "GreaterThanOrEqualToDateValidator.date must be on or after 2020-01-01" }); }
        ...
        static validateField<K extends keyof GreaterThanOrEqualToDateValidator>(
            ...
            if (_field === "date") {
                const __val = _value as Date;
                                                if (__val.getTime() < new Date("2020-01-01").getTime()) { errors.push({ field: "date", message: "GreaterThanOrEqualToDateValidator.date must be on or after 2020-01-01" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function greaterThanOrEqualToDateValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: GreaterThanOrEqualToDateValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return GreaterThanOrEqualToDateValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function greaterThanOrEqualToDateValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): GreaterThanOrEqualToDateValidator | __mf_PendingRef {
            return GreaterThanOrEqualToDateValidator.deserializeWithContext(value, ctx);
        }

        /** Type guard: checks if a value can be successfully deserialized. @param value - The value to check @returns True if the value can be deserialized to this type  */
        export function greaterThanOrEqualToDateValidatorIs(value: unknown): value is GreaterThanOrEqualToDateValidator {
...
constructor(props: { date: Date }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: LessThanDateValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): LessThanDateValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "LessThanDateValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                            const __raw_date = obj["date"] as string | Date;{
                                        const __dateVal = typeof __raw_date === "string" ? new Date(__raw_date) : __raw_date as Date;
                                                                            if (__dateVal.getTime() >= new Date("2030-01-01").getTime()) { errors.push({ field: "date", message: "LessThanDateValidator.date must be before 2030-01-01" }); }
        ...
        static validateField<K extends keyof LessThanDateValidator>(
            ...
            if (_field === "date") {
                const __val = _value as Date;
                                                if (__val.getTime() >= new Date("2030-01-01").getTime()) { errors.push({ field: "date", message: "LessThanDateValidator.date must be before 2030-01-01" }); }
        ...
        static validateFields(
            _partial: Partial<LessThanDateValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
            if ("date" in _partial && _partial.date !== undefined) {
                const __val = _partial.date as Date;
                                                if (__val.getTime() >= new Date("2030-01-01").getTime()) { errors.push({ field: "date", message: "LessThanDateValidator.date must be before 2030-01-01" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function lessThanDateValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: LessThanDateValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return LessThanDateValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function lessThanDateValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): LessThanDateValidator | __mf_PendingRef {
...
constructor(props: { date: Date }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: LessThanOrEqualToDateValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): LessThanOrEqualToDateValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "LessThanOrEqualToDateValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                            const __raw_date = obj["date"] as string | Date;{
                                        const __dateVal = typeof __raw_date === "string" ? new Date(__raw_date) : __raw_date as Date;
                                                                            if (__dateVal.getTime() > new Date("2030-01-01").getTime()) { errors.push({ field: "date", message: "LessThanOrEqualToDateValidator.date must be on or before 2030-01-01" }); }
        ...
        static validateField<K extends keyof LessThanOrEqualToDateValidator>(
            ...
            if (_field === "date") {
                const __val = _value as Date;
                                                if (__val.getTime() > new Date("2030-01-01").getTime()) { errors.push({ field: "date", message: "LessThanOrEqualToDateValidator.date must be on or before 2030-01-01" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function lessThanOrEqualToDateValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: LessThanOrEqualToDateValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return LessThanOrEqualToDateValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function lessThanOrEqualToDateValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): LessThanOrEqualToDateValidator | __mf_PendingRef {
            return LessThanOrEqualToDateValidator.deserializeWithContext(value, ctx);
        }

        /** Type guard: checks if a value can be successfully deserialized. @param value - The value to check @returns True if the value can be deserialized to this type  */
        export function lessThanOrEqualToDateValidatorIs(value: unknown): value is LessThanOrEqualToDateValidator {
...
constructor(props: { date: Date }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: BetweenDateValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): BetweenDateValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "BetweenDateValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                            const __raw_date = obj["date"] as string | Date;{
                                        const __dateVal = typeof __raw_date === "string" ? new Date(__raw_date) : __raw_date as Date;
                                                                            if (__dateVal.getTime() < new Date("2020-01-01").getTime() || __dateVal.getTime() > new Date("2030-01-01").getTime()) { errors.push({ field: "date", message: "BetweenDateValidator.date must be between 2020-01-01 and 2030-01-01" }); }
        ...
        static validateField<K extends keyof BetweenDateValidator>(
            ...
            if (_field === "date") {
                const __val = _value as Date;
                                                if (__val.getTime() < new Date("2020-01-01").getTime() || __val.getTime() > new Date("2030-01-01").getTime()) { errors.push({ field: "date", message: "BetweenDateValidator.date must be between 2020-01-01 and 2030-01-01" }); }
        ...
        static validateFields(
            _partial: Partial<BetweenDateValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
            if ("date" in _partial && _partial.date !== undefined) {
                const __val = _partial.date as Date;
                                                if (__val.getTime() < new Date("2020-01-01").getTime() || __val.getTime() > new Date("2030-01-01").getTime()) { errors.push({ field: "date", message: "BetweenDateValidator.date must be between 2020-01-01 and 2030-01-01" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function betweenDateValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: BetweenDateValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return BetweenDateValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function betweenDateValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): BetweenDateValidator | __mf_PendingRef {
