...
export class ValidDateValidator {
    ...
    ctx.trackForFreeze(instance);
    {
        ...
        {
            const __dateVal = typeof __raw_date === "string" ? new Date(__raw_date) : $MfPh116 as Date;
...
export function validDateValidatorDeserialize(input: unknown, opts: __mf_DeserializeOptions): {
    success: true;
    value: ValidDateValidator;
} | {
    success: false;
...
export function greaterThanDateValidatorDeserialize(input: unknown, opts: __mf_DeserializeOptions): {
    success: true;
    value: GreaterThanDateValidator;
} | {
    success: false;
...
export function greaterThanOrEqualToDateValidatorDeserialize(input: unknown, opts: __mf_DeserializeOptions): {
    success: true;
    value: GreaterThanOrEqualToDateValidator;
} | {
    success: false;
...
export function lessThanDateValidatorDeserialize(input: unknown, opts: __mf_DeserializeOptions): {
    success: true;
    value: LessThanDateValidator;
} | {
    success: false;
...
export function lessThanOrEqualToDateValidatorDeserialize(input: unknown, opts: __mf_DeserializeOptions): {
    success: true;
    value: LessThanOrEqualToDateValidator;
} | {
    success: false;
...
export function betweenDateValidatorDeserialize(input: unknown, opts: __mf_DeserializeOptions): {
    success: true;
    value: BetweenDateValidator;
} | {
    success: false;
