    ...
    ctx.trackForFreeze(instance);
    {
        const __raw_date = obj["date"] as Date;
        {
            ...
            if (isNaN(__dateVal.getTime())) {
                errors.push({
                    field: "date",
                    message: "ValidDateValidator.date must be a valid date"
                });
            }
    ...
    ctx.trackForFreeze(instance);
    {
        const __raw_date = obj["date"] as Date;
        {
            ...
            if (__dateVal.getTime() <= new Date("2020-01-01").getTime()) {
                errors.push({
                    field: "date",
                    message: "GreaterThanDateValidator.date must be after 2020-01-01"
                });
            }
            instance.date = __dateVal;
        }
    ...
    ctx.trackForFreeze(instance);
    {
        const __raw_date = obj["date"] as Date;
        {
            ...
            if (__dateVal.getTime() < new Date("2020-01-01").getTime()) {
                errors.push({
                    field: "date",
                    message: "GreaterThanOrEqualToDateValidator.date must be on or after 2020-01-01"
                });
            }
            instance.date = __dateVal;
        }
...
/** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context   */
    ...
    ctx.trackForFreeze(instance);
    {
        ...
        {
            const __dateVal = typeof __raw_date === "string" ? new Date(__raw_date) : __raw_date as Date;
            if (__dateVal.getTime() >= new Date("2030-01-01").getTime()) {
                errors.push({
                    field: "date",
                    message: "LessThanDateValidator.date must be before 2030-01-01"
                });
            }
            instance.date = __dateVal;
        }
    ...
    if (_field === "date") {
        const __val = _value as Date;
        if (__val.getTime() >= new Date("2030-01-01").getTime()) {
            errors.push({
                field: "date",
                message: "LessThanDateValidator.date must be before 2030-01-01"
            });
    ...
    ctx.trackForFreeze(instance);
    {
        const __raw_date = obj["date"] as Date;
        {
            ...
            if (__dateVal.getTime() > new Date("2030-01-01").getTime()) {
                errors.push({
                    field: "date",
                    message: "LessThanOrEqualToDateValidator.date must be on or before 2030-01-01"
                });
            }
            instance.date = __dateVal;
        }
...
/** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context   */
    ...
    ctx.trackForFreeze(instance);
    {
        ...
        {
            const __dateVal = typeof __raw_date === "string" ? new Date(__raw_date) : __raw_date as Date;
            if (__dateVal.getTime() < new Date("2020-01-01").getTime() || __dateVal.getTime() > new Date("2030-01-01").getTime()) {
                errors.push({
                    field: "date",
                    message: "BetweenDateValidator.date must be between 2020-01-01 and 2030-01-01"
                });
            }
            instance.date = __dateVal;
        }
    ...
    if (_field === "date") {
        const __val = _value as Date;
        if (__val.getTime() < new Date("2020-01-01").getTime() || __val.getTime() > new Date("2030-01-01").getTime()) {
            errors.push({
                field: "date",
                message: "BetweenDateValidator.date must be between 2020-01-01 and 2030-01-01"
            });
