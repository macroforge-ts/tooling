...
constructor(props: { value: bigint }) {
        ...
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: GreaterThanBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): GreaterThanBigIntValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "GreaterThanBigIntValidator.deserializeWithContext: expected an object" }]);
            }

            const obj = value as Record<string, unknown>;
            const errors: Array<{ field: string; message: string }> = [];if (!("value" in obj)) {
            ...
            ctx.trackForFreeze(instance);{
                                    const __convertedVal = ((v) => BigInt(v as string))(obj["value"]);
                                                                    if (__convertedVal <= 0n) { errors.push({ field: "value", message: "GreaterThanBigIntValidator.value must be greater than 0" }); }
        ...
        static validateField<K extends keyof GreaterThanBigIntValidator>(
            ...
            if (_field === "value") {
                const __val = _value as bigint;
                                                if (__val <= 0n) { errors.push({ field: "value", message: "GreaterThanBigIntValidator.value must be greater than 0" }); }
        ...
        static validateFields(
            _partial: Partial<GreaterThanBigIntValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function greaterThanBigIntValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: GreaterThanBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return GreaterThanBigIntValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function greaterThanBigIntValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): GreaterThanBigIntValidator | __mf_PendingRef {
...
constructor(props: { value: bigint }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: GreaterThanOrEqualToBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): GreaterThanOrEqualToBigIntValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "GreaterThanOrEqualToBigIntValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                                    const __convertedVal = ((v) => BigInt(v as string))(obj["value"]);
                                                                    if (__convertedVal < 0n) { errors.push({ field: "value", message: "GreaterThanOrEqualToBigIntValidator.value must be greater than or equal to 0" }); }
        ...
        static validateField<K extends keyof GreaterThanOrEqualToBigIntValidator>(
            ...
            if (_field === "value") {
                const __val = _value as bigint;
                                                if (__val < 0n) { errors.push({ field: "value", message: "GreaterThanOrEqualToBigIntValidator.value must be greater than or equal to 0" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function greaterThanOrEqualToBigIntValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: GreaterThanOrEqualToBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return GreaterThanOrEqualToBigIntValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function greaterThanOrEqualToBigIntValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): GreaterThanOrEqualToBigIntValidator | __mf_PendingRef {
            return GreaterThanOrEqualToBigIntValidator.deserializeWithContext(value, ctx);
        }

        /** Type guard: checks if a value can be successfully deserialized. @param value - The value to check @returns True if the value can be deserialized to this type  */
        export function greaterThanOrEqualToBigIntValidatorIs(value: unknown): value is GreaterThanOrEqualToBigIntValidator {
...
constructor(props: { value: bigint }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: LessThanBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): LessThanBigIntValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "LessThanBigIntValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                                    const __convertedVal = ((v) => BigInt(v as string))(obj["value"]);
                                                                    if (__convertedVal >= 1000n) { errors.push({ field: "value", message: "LessThanBigIntValidator.value must be less than 1000" }); }
        ...
        static validateField<K extends keyof LessThanBigIntValidator>(
            ...
            if (_field === "value") {
                const __val = _value as bigint;
                                                if (__val >= 1000n) { errors.push({ field: "value", message: "LessThanBigIntValidator.value must be less than 1000" }); }
        ...
        static validateFields(
            _partial: Partial<LessThanBigIntValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
            if ("value" in _partial && _partial.value !== undefined) {
                const __val = _partial.value as bigint;
                                                if (__val >= 1000n) { errors.push({ field: "value", message: "LessThanBigIntValidator.value must be less than 1000" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function lessThanBigIntValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: LessThanBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return LessThanBigIntValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function lessThanBigIntValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): LessThanBigIntValidator | __mf_PendingRef {
...
constructor(props: { value: bigint }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: LessThanOrEqualToBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): LessThanOrEqualToBigIntValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "LessThanOrEqualToBigIntValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                                    const __convertedVal = ((v) => BigInt(v as string))(obj["value"]);
                                                                    if (__convertedVal > 1000n) { errors.push({ field: "value", message: "LessThanOrEqualToBigIntValidator.value must be less than or equal to 1000" }); }
        ...
        static validateField<K extends keyof LessThanOrEqualToBigIntValidator>(
            ...
            if (_field === "value") {
                const __val = _value as bigint;
                                                if (__val > 1000n) { errors.push({ field: "value", message: "LessThanOrEqualToBigIntValidator.value must be less than or equal to 1000" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function lessThanOrEqualToBigIntValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: LessThanOrEqualToBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return LessThanOrEqualToBigIntValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function lessThanOrEqualToBigIntValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): LessThanOrEqualToBigIntValidator | __mf_PendingRef {
            return LessThanOrEqualToBigIntValidator.deserializeWithContext(value, ctx);
        }

        /** Type guard: checks if a value can be successfully deserialized. @param value - The value to check @returns True if the value can be deserialized to this type  */
        export function lessThanOrEqualToBigIntValidatorIs(value: unknown): value is LessThanOrEqualToBigIntValidator {
...
constructor(props: { value: bigint }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: BetweenBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): BetweenBigIntValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "BetweenBigIntValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                                    const __convertedVal = ((v) => BigInt(v as string))(obj["value"]);
                                                                    if (__convertedVal < 0n || __convertedVal > 1000n) { errors.push({ field: "value", message: "BetweenBigIntValidator.value must be between 0 and 1000" }); }
        ...
        static validateField<K extends keyof BetweenBigIntValidator>(
            ...
            if (_field === "value") {
                const __val = _value as bigint;
                                                if (__val < 0n || __val > 1000n) { errors.push({ field: "value", message: "BetweenBigIntValidator.value must be between 0 and 1000" }); }
        ...
        static validateFields(
            _partial: Partial<BetweenBigIntValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
            if ("value" in _partial && _partial.value !== undefined) {
                const __val = _partial.value as bigint;
                                                if (__val < 0n || __val > 1000n) { errors.push({ field: "value", message: "BetweenBigIntValidator.value must be between 0 and 1000" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function betweenBigIntValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: BetweenBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return BetweenBigIntValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function betweenBigIntValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): BetweenBigIntValidator | __mf_PendingRef {
...
constructor(props: { value: bigint }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: PositiveBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): PositiveBigIntValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "PositiveBigIntValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                                    const __convertedVal = ((v) => BigInt(v as string))(obj["value"]);
                                                                    if (__convertedVal <= 0n) { errors.push({ field: "value", message: "PositiveBigIntValidator.value must be positive" }); }
        ...
        static validateField<K extends keyof PositiveBigIntValidator>(
            ...
            if (_field === "value") {
                const __val = _value as bigint;
                                                if (__val <= 0n) { errors.push({ field: "value", message: "PositiveBigIntValidator.value must be positive" }); }
        ...
        static validateFields(
            _partial: Partial<PositiveBigIntValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
            if ("value" in _partial && _partial.value !== undefined) {
                const __val = _partial.value as bigint;
                                                if (__val <= 0n) { errors.push({ field: "value", message: "PositiveBigIntValidator.value must be positive" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function positiveBigIntValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: PositiveBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return PositiveBigIntValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function positiveBigIntValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): PositiveBigIntValidator | __mf_PendingRef {
...
constructor(props: { value: bigint }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: NonNegativeBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): NonNegativeBigIntValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "NonNegativeBigIntValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                                    const __convertedVal = ((v) => BigInt(v as string))(obj["value"]);
                                                                    if (__convertedVal < 0n) { errors.push({ field: "value", message: "NonNegativeBigIntValidator.value must be non-negative" }); }
        ...
        static validateField<K extends keyof NonNegativeBigIntValidator>(
            ...
            if (_field === "value") {
                const __val = _value as bigint;
                                                if (__val < 0n) { errors.push({ field: "value", message: "NonNegativeBigIntValidator.value must be non-negative" }); }
        ...
        static validateFields(
            _partial: Partial<NonNegativeBigIntValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
            if ("value" in _partial && _partial.value !== undefined) {
                const __val = _partial.value as bigint;
                                                if (__val < 0n) { errors.push({ field: "value", message: "NonNegativeBigIntValidator.value must be non-negative" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function nonNegativeBigIntValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: NonNegativeBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return NonNegativeBigIntValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function nonNegativeBigIntValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): NonNegativeBigIntValidator | __mf_PendingRef {
...
constructor(props: { value: bigint }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: NegativeBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): NegativeBigIntValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "NegativeBigIntValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                                    const __convertedVal = ((v) => BigInt(v as string))(obj["value"]);
                                                                    if (__convertedVal >= 0n) { errors.push({ field: "value", message: "NegativeBigIntValidator.value must be negative" }); }
        ...
        static validateField<K extends keyof NegativeBigIntValidator>(
            ...
            if (_field === "value") {
                const __val = _value as bigint;
                                                if (__val >= 0n) { errors.push({ field: "value", message: "NegativeBigIntValidator.value must be negative" }); }
        ...
        static validateFields(
            _partial: Partial<NegativeBigIntValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
            if ("value" in _partial && _partial.value !== undefined) {
                const __val = _partial.value as bigint;
                                                if (__val >= 0n) { errors.push({ field: "value", message: "NegativeBigIntValidator.value must be negative" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function negativeBigIntValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: NegativeBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return NegativeBigIntValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function negativeBigIntValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): NegativeBigIntValidator | __mf_PendingRef {
...
constructor(props: { value: bigint }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: NonPositiveBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): NonPositiveBigIntValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "NonPositiveBigIntValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                                    const __convertedVal = ((v) => BigInt(v as string))(obj["value"]);
                                                                    if (__convertedVal > 0n) { errors.push({ field: "value", message: "NonPositiveBigIntValidator.value must be non-positive" }); }
        ...
        static validateField<K extends keyof NonPositiveBigIntValidator>(
            ...
            if (_field === "value") {
                const __val = _value as bigint;
                                                if (__val > 0n) { errors.push({ field: "value", message: "NonPositiveBigIntValidator.value must be non-positive" }); }
        ...
        static validateFields(
            _partial: Partial<NonPositiveBigIntValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
            if ("value" in _partial && _partial.value !== undefined) {
                const __val = _partial.value as bigint;
                                                if (__val > 0n) { errors.push({ field: "value", message: "NonPositiveBigIntValidator.value must be non-positive" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function nonPositiveBigIntValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: NonPositiveBigIntValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return NonPositiveBigIntValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function nonPositiveBigIntValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): NonPositiveBigIntValidator | __mf_PendingRef {
