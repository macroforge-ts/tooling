...
constructor(props: { items: Array<string> }) {
        ...
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: MaxItemsValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): MaxItemsValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "MaxItemsValidator.deserializeWithContext: expected an object" }]);
            }

            const obj = value as Record<string, unknown>;
            const errors: Array<{ field: string; message: string }> = [];if (!("items" in obj)) {
                        errors.push({ field: "items", message: "missing required field" });
                    }
            ...
            ctx.trackForFreeze(instance);{
                            const __raw_items = obj["items"] as Array<string>;if (Array.isArray(__raw_items)) {
                                                                            if (__raw_items.length > 5) { errors.push({ field: "items", message: "MaxItemsValidator.items must have at most 5 items" }); }
instance.items = __raw_items as string[];
        ...
        static validateField<K extends keyof MaxItemsValidator>(
            ...
            if (_field === "items") {
                const __val = _value as Array<string>;
                                                if (__val.length > 5) { errors.push({ field: "items", message: "MaxItemsValidator.items must have at most 5 items" }); }
        ...
        static validateFields(
            _partial: Partial<MaxItemsValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
            if ("items" in _partial && _partial.items !== undefined) {
                const __val = _partial.items as Array<string>;
                                                if (__val.length > 5) { errors.push({ field: "items", message: "MaxItemsValidator.items must have at most 5 items" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function maxItemsValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: MaxItemsValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return MaxItemsValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function maxItemsValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): MaxItemsValidator | __mf_PendingRef {
            return MaxItemsValidator.deserializeWithContext(value, ctx);
        }
...
constructor(props: { items: Array<string> }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: MinItemsValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): MinItemsValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "MinItemsValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                            const __raw_items = obj["items"] as Array<string>;if (Array.isArray(__raw_items)) {
                                                                            if (__raw_items.length < 2) { errors.push({ field: "items", message: "MinItemsValidator.items must have at least 2 items" }); }
instance.items = __raw_items as string[];
        ...
        static validateField<K extends keyof MinItemsValidator>(
            ...
            if (_field === "items") {
                const __val = _value as Array<string>;
                                                if (__val.length < 2) { errors.push({ field: "items", message: "MinItemsValidator.items must have at least 2 items" }); }
        ...
        static validateFields(
            _partial: Partial<MinItemsValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
            if ("items" in _partial && _partial.items !== undefined) {
                const __val = _partial.items as Array<string>;
                                                if (__val.length < 2) { errors.push({ field: "items", message: "MinItemsValidator.items must have at least 2 items" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function minItemsValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: MinItemsValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return MinItemsValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function minItemsValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): MinItemsValidator | __mf_PendingRef {
            return MinItemsValidator.deserializeWithContext(value, ctx);
        }
...
constructor(props: { items: Array<string> }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: ItemsCountValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): ItemsCountValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "ItemsCountValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                            const __raw_items = obj["items"] as Array<string>;if (Array.isArray(__raw_items)) {
                                                                            if (__raw_items.length !== 3) { errors.push({ field: "items", message: "ItemsCountValidator.items must have exactly 3 items" }); }
instance.items = __raw_items as string[];
        ...
        static validateField<K extends keyof ItemsCountValidator>(
            ...
            if (_field === "items") {
                const __val = _value as Array<string>;
                                                if (__val.length !== 3) { errors.push({ field: "items", message: "ItemsCountValidator.items must have exactly 3 items" }); }
        ...
        static validateFields(
            _partial: Partial<ItemsCountValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
            if ("items" in _partial && _partial.items !== undefined) {
                const __val = _partial.items as Array<string>;
                                                if (__val.length !== 3) { errors.push({ field: "items", message: "ItemsCountValidator.items must have exactly 3 items" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function itemsCountValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: ItemsCountValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return ItemsCountValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function itemsCountValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): ItemsCountValidator | __mf_PendingRef {
            return ItemsCountValidator.deserializeWithContext(value, ctx);
        }
