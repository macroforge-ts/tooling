...
export function customNumberValidatorDeserialize(input: unknown, opts: __mf_DeserializeOptions): {
    success: true;
    value: CustomNumberValidator;
} | {
    success: false;
...
export function customStringValidatorDeserialize(input: unknown, opts: __mf_DeserializeOptions): {
    success: true;
    value: CustomStringValidator;
} | {
    success: false;
...
export function customWithMessageValidatorDeserialize(input: unknown, opts: __mf_DeserializeOptions): {
    success: true;
    value: CustomWithMessageValidator;
} | {
    success: false;
