...
constructor(props: { evenNumber: number }) {
        ...
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: CustomNumberValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
		field: "_root",
		message: "CustomNumberValidator.deserialize: root cannot be a forward reference"
	}]
});
                }
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): CustomNumberValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "CustomNumberValidator.deserializeWithContext: expected an object" }]);
            }

            const obj = value as Record<string, unknown>;
            const errors: Array<{ field: string; message: string }> = [];if (!("evenNumber" in obj)) {
            ...
            ctx.trackForFreeze(instance);{
                            const __raw_evenNumber = obj["evenNumber"] as number;
                                                                        if (!isEven(__raw_evenNumber)) { errors.push({ field: "evenNumber", message: "CustomNumberValidator.evenNumber failed custom validation (isEven)" }); }
instance.evenNumber = __raw_evenNumber;
        ...
        static validateField<K extends keyof CustomNumberValidator>(
            ...
            if (_field === "evenNumber") {
                const __val = _value as number;
                                                if (!isEven(__val)) { errors.push({ field: "evenNumber", message: "CustomNumberValidator.evenNumber failed custom validation (isEven)" }); }
        ...
        static validateFields(
            _partial: Partial<CustomNumberValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function customNumberValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: CustomNumberValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return CustomNumberValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function customNumberValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): CustomNumberValidator | __mf_PendingRef {
...
constructor(props: { username: string }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: CustomStringValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
		field: "_root",
		message: "CustomStringValidator.deserialize: root cannot be a forward reference"
	}]
});
                }
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): CustomStringValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "CustomStringValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                            const __raw_username = obj["username"] as string;
                                                                        if (!isValidUsername(__raw_username)) { errors.push({ field: "username", message: "CustomStringValidator.username failed custom validation (isValidUsername)" }); }
instance.username = __raw_username;
        ...
        static validateField<K extends keyof CustomStringValidator>(
            ...
            if (_field === "username") {
                const __val = _value as string;
                                                if (!isValidUsername(__val)) { errors.push({ field: "username", message: "CustomStringValidator.username failed custom validation (isValidUsername)" }); }
        ...
        static validateFields(
            _partial: Partial<CustomStringValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function customStringValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: CustomStringValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return CustomStringValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function customStringValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): CustomStringValidator | __mf_PendingRef {
...
constructor(props: { evenNumber: number }) {
        ...
        /** Deserializes input to an instance of this class. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        static deserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: CustomWithMessageValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            try {
	...
	errors: [{
		field: "_root",
		message: "CustomWithMessageValidator.deserialize: root cannot be a forward reference"
	}]
});
                }
	...
	errors: [{
        ...
        static deserializeWithContext(value: any, ctx: __mf_DeserializeContext): CustomWithMessageValidator | __mf_PendingRef {
            ...
            if (typeof value !== "object" || value === null || Array.isArray(value)) {
                throw new __mf_DeserializeError([{ field: "_root", message: "CustomWithMessageValidator.deserializeWithContext: expected an object" }]);
            }
            ...
            ctx.trackForFreeze(instance);{
                            const __raw_evenNumber = obj["evenNumber"] as number;
                                                                        if (!isEven(__raw_evenNumber)) { errors.push({ field: "evenNumber", message: "Number must be even" }); }
instance.evenNumber = __raw_evenNumber;
        ...
        static validateField<K extends keyof CustomWithMessageValidator>(
            ...
            if (_field === "evenNumber") {
                const __val = _value as number;
                                                if (!isEven(__val)) { errors.push({ field: "evenNumber", message: "Number must be even" }); }
        ...
        static validateFields(
            _partial: Partial<CustomWithMessageValidator>
        ): Array<{ field: string; message: string }> {const errors: Array<{ field: string; message: string }> = [];
            if ("evenNumber" in _partial && _partial.evenNumber !== undefined) {
                const __val = _partial.evenNumber as number;
                                                if (!isEven(__val)) { errors.push({ field: "evenNumber", message: "Number must be even" }); }
...
/** Deserializes input to an instance. Automatically detects whether input is a JSON string or object. @param input - JSON string or object to deserialize @param opts - Optional deserialization options @returns Result containing the deserialized instance or validation errors  */
        export function customWithMessageValidatorDeserialize(input: unknown, opts?: __mf_DeserializeOptions): { success: true; value: CustomWithMessageValidator } | { success: false; errors: Array<{ field: string; message: string }> } {
            return CustomWithMessageValidator.deserialize(input, opts);
        }

        /** Deserializes with an existing context for nested/cyclic object graphs. @param value - The raw value to deserialize @param ctx - The deserialization context  */
        export function customWithMessageValidatorDeserializeWithContext(value: any, ctx: __mf_DeserializeContext): CustomWithMessageValidator | __mf_PendingRef {
