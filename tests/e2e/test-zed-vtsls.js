...
const ZED_VTSLS =
    '/Users/jakoblochinski/Library/Application Support/Zed/languages/vtsls/node_modules/@vtsls/language-server/bin/vtsls.js';
...
console.log(
    '\nSending initialize with options:',
    JSON.stringify(initParams.initializationOptions, null, 2)
);
...
server.stdout.on('data', (data) => {
    ...
    if (!initialized && text.includes('"id":1')) {
        ...
        server.stdin.write(
            `Content-Length: ${Buffer.byteLength(initializedMsg)}\r\n\r\n${initializedMsg}`
        );
